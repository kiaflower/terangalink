...
const KEY = 'terangalink_favorites'
...
export function FavoriteButton({ productId, restaurantSlug, restaurantName, name, imageUrl, price }: Props) {
  ...
  function toggle(e: React.MouseEvent) {
    ...
    const next: FavoriteItem[] = exists
      ...
      : [...favs, { product_id: productId, restaurant_slug: restaurantSlug, restaurant_name: restaurantName, name, image_url: imageUrl, price }]
