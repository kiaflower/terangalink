                      ...
                      {restaurant.snapchat_url && (
                        <a href={restaurant.snapchat_url} target="_blank" rel="noopener noreferrer"
                          ...
                          <svg viewBox="0 0 24 24" className="w-5 h-5" fill="currentColor">
                            <path d="M12 2c-1.7 0-5.5.7-5.5 5.9 0 .4 0 .8.1 1.2-.3.2-.7.3-1.1.2-.2-.1-.5-.1-.7-.1-.8 0-1.3.5-1.3 1.1 0 .5.4.9 1 1.1-.3.4-.8.7-1.1 1-.2.1-.3.4-.2.6.1.3.4.5.7.6.1 0 .3.1.4.1h.1c-.1.3-.2.6-.2.9 0 2.1 1.7 3.8 3.8 3.8.4 0 .8-.1 1.1-.2.6 1 1.6 1.7 2.9 1.7s2.3-.7 2.9-1.7c.3.1.7.2 1.1.2 2.1 0 3.8-1.7 3.8-3.8 0-.3-.1-.6-.2-.9h.1c.1 0 .3 0 .4-.1.3-.1.6-.3.7-.6.1-.2 0-.5-.2-.6-.3-.3-.8-.6-1.1-1 .6-.2 1-.6 1-1.1 0-.6-.5-1.1-1.3-1.1-.2 0-.5 0-.7.1-.4.1-.8 0-1.1-.2 0-.4.1-.8.1-1.2C17.5 2.7 13.7 2 12 2z"/>
                          </svg>
                        </a>
                      )}
                    </div>
