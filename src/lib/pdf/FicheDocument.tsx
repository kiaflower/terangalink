...
const styles = StyleSheet.create({
  ...
  sectionTitle: { fontSize: 9, fontFamily: 'Helvetica-Bold', color: '#F97316', textTransform: 'uppercase', letterSpacing: 1, marginBottom: 8 },
  bodyText: { fontSize: 11, color: '#374151', lineHeight: 1.5 },
  keyPointRow: { flexDirection: 'row', marginBottom: 6, alignItems: 'flex-start' },
  keyPointBullet: { width: 5, height: 5, borderRadius: 2.5, backgroundColor: '#F97316', marginTop: 4, marginRight: 8 },
